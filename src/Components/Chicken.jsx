...
const Chicken = () => {
    ...
    // Live Search Filter
    const filteredChicken = chickenitems.filter((chicken) =>
        chicken.foodname.toLowerCase().includes(search.toLowerCase()) ||
        chicken.ingredients.toLowerCase().includes(search.toLowerCase()) ||
        chicken.fooddesc.toLowerCase().includes(search.toLowerCase())
    )
    ...
    const showChicken = async (_id) => {
        ...
        try {
            ...
            foodnameref.current.value = chicken.data.foodname
            ingredientsref.current.value = chicken.data.ingredients
            fooddescref.current.value = chicken.data.fooddesc
            hiddenref.current.value = chicken.data._id
    ...
    return (
        ...
        <div className='min-h-screen bg-[#fff8f0] px-4 sm:px-6 md:px-10 py-10 md:py-15'>
            ...
            <div className='text-center mb-10 md:mb-14'>
                ...
                >
                    চিকেনের জনপ্রিয় রেসিপি
                </h1>

                <p className='text-gray-600 text-base md:text-lg'>
                    বাংলার ঐতিহ্যবাহী স্বাদের সেরা চিকেনের পদ
                </p>
            ...
            <div className='flex justify-center mb-10'>
                ...
                <input
                    type="text"
                    placeholder='চিকেন রেসিপি খুঁজুন...'
                    value={search}
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-10'>
                ...
                {filteredChicken.length > 0 ? (

                    filteredChicken.map((chicken, index) => (
                        ...
                        >
                            ...
                            <div className='p-5 md:p-6'>
                                ...
                                <div className='flex flex-wrap gap-3'>
                                    ...
                                    {/* Edit Button */}
                                    {/* <button
                                        onClick={() => showChicken(chicken._id)}
                    ...
                    <div className='col-span-full text-center text-xl md:text-2xl font-bold text-gray-500'>
                        কোনো চিকেন রেসিপি পাওয়া যায়নি
                    </div>
