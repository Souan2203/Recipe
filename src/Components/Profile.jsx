...
const Profile = () => {
    ...
    const fetchchicken = async () => {
        ...
        try {
            ...
            const apiUrl = "https://recipe-backend-deployement-mkke.vercel.app/api/chicken/get"
    ...
    const fetchFish = async () => {
        ...
        try {
            ...
            const apiUrl = "https://recipe-backend-deployement-mkke.vercel.app/api/fish/get"
    ...
    const fetchMutton = async () => {
        ...
        try {
            ...
            const apiUrl = "https://recipe-backend-deployement-mkke.vercel.app/api/mutton/get"
    ...
    const fetchsweet = async () => {
        ...
        try {
            ...
            const apiUrl = "https://recipe-backend-deployement-mkke.vercel.app/api/sweet/get"
    ...
    const fetchRice = async () => {
        ...
        try {
            ...
            const apiUrl = "https://recipe-backend-deployement-mkke.vercel.app/api/rice/get"
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // DYNAMIC UPDATE API
            const apiUrl = `https://recipe-backend-deployement-mkke.vercel.app/api/${foodType}/update/${selectedFood._id}`
    ...
    const handleDelete = async (id, type) => {
        ...
        try {
            ...
            const apiUrl = `https://recipe-backend-deployement-mkke.vercel.app/api/${type}/delete/${id}`
